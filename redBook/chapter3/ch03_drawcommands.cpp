...
void DrawCommandExample::Initialize(const char * title)
{
    ...
    {
        { GL_VERTEX_SHADER, "E:\\workspace_cpp\\_opengl 编程指南\\oglpg-8th-edition 源码\\03\\ch03_primitive_restart\\primitive_restart.vs.glsl" },
        { GL_FRAGMENT_SHADER, "E:\\workspace_cpp\\_opengl 编程指南\\oglpg-8th-edition 源码\\03\\ch03_primitive_restart\\primitive_restart.fs.glsl" },
        { GL_NONE, NULL }
    };
